...
_SYSTEM = (
    ...
    "length / format). Do NOT restate the numbers. Explain WHY the winners win and the "
    "losers lose — the causal pattern in hook style, topic, emotional trigger, length, and "
    "opening moment. Be specific and falsifiable, not generic. Then give exactly 3 concrete, "
    "testable creative changes for next cycle (e.g. 'open more hooks with a number', 'cut "
    "30-45s clips to 20-30s', 'lead with loss not curiosity for finance'). Format as short "
    "markdown: a '**Why:**' paragraph then a '**Do next:**' list of 3. Under 180 words."
)
