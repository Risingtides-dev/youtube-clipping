...
QUESTS = [
    ...
    ("3 · Crash Out (comedy/reaction)", "owned",
     ["Bad Friends", "Kill Tony", "This Is Important", "ModernWisdom"]),
    ("4 · Myth-Busting (health/fitness)", "owned",
...
def compute(df: pd.DataFrame) -> dict:
    ...
    if df.empty:
        ...
        return {"run_rate": 0.0, "views": 0, "clips": 0, "posted": 0, "channels": 0,
                "hits": 0, "hit_rate": 0.0, "ads": 0.0, "best": None,
...
| stat | value |
|---|---|
| 💵 Monthly run-rate | **{_money(s['run_rate'])}** (ad revenue, owned channels) |
